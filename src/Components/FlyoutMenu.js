...
const FlyoutMenu = ({ isAuthenticated, handleLogin, setMenuOpen }) => {
    return (
        <div className="fixed top-0 left-0 h-full bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 z-50 p-6 w-4/5 md:w-64 shadow-lg" style={{ backgroundColor: 'inherit' }}>
            ...
            <div className="mt-6 space-y-6">
                {/* Home Menu Item */}
                <div className="border-b pb-2 hover:text-blue-400 cursor-pointer flex justify-between items-center">
                    <span>Home</span>
                ...
                {!isAuthenticated ? (
                    <div className="border-b pb-2 hover:text-blue-400 cursor-pointer flex justify-between items-center" onClick={handleLogin}>
                        <span>Login</span>
